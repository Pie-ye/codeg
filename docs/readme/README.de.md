...
**Desktop** — Lade den Installer für macOS, Windows oder Linux aus den [Releases](https://github.com/Pie-ye/codeg/releases) und folge der [Installation](https://docs.codeg.app/getting-started/installation).
