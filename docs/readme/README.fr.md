...
**Bureau** — téléchargez l'installateur macOS, Windows ou Linux depuis les [Releases](https://github.com/Pie-ye/codeg/releases), puis suivez l'[Installation](https://docs.codeg.app/getting-started/installation).
